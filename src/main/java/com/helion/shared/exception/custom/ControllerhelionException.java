...
public class ControllerhelionException extends helionException {

	@Serial
	private static final long serialVersionUID = 1L;
	private static final LocationException location = LocationException.CONTROLLER;

	public ControllerhelionException(final String userMessage) {
		super(userMessage, location);
	}

	public ControllerhelionException(final String technicalMessage, final String userMessage) {
